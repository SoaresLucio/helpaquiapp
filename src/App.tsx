    ...
    <Suspense fallback={<LoadingScreen />}>
      <AnimatePresence mode="wait">
        <Routes location={location} key={location.pathname}>
          ...
          <Route path="/category-management" element={<SEOPage title="Gerenciar Categorias" description="Gerencie as categorias de serviços." path="/category-management" noIndex><ProtectedRoute adminOnly><CategoryManagement /></ProtectedRoute></SEOPage>} />
