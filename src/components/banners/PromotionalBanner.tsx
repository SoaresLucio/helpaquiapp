  ...
  return <div className={`relative rounded-xl overflow-hidden shadow-lg ${className}`}>
      ...
      minHeight: '300px'
        ...
        <div className="relative h-full flex items-center justify-between p-6 md:p-8 min-h-[300px]">
          ...
          {ctaText && linkUrl && <div className="ml-4">
              <Button variant="secondary" size="lg" onClick={handleClick} className="bg-white/90 hover:bg-white text-gray-900 font-semibold shadow-lg">
                {ctaText}
